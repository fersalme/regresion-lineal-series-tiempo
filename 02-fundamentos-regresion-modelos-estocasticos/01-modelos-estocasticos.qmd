...
- Otro análisis útil es graficar el histograma de los errores y sus valores en el tiempo. En este análisis buscamos patrones de la serie no incluidos en el modelo y errores extremos.

![](src/img/tsresiduals.png)

### Test formal de Ljung-Box para la autocorrelación
...
H0 : Los ACF de $\ell$ resagos **no son** distintos de un proceso ruido blanco
Ha : Al menos uno de los ACF $\ell$ resagos **son** distintos de un proceso ruido blanco
...
- Hacer el diagnostico del modelo macroeconómico del crecimiento del consumo en Estados Unidos. 

...
| ARIMA(1,0,0) sin constante | Camino aleatorio | $Y_t = Y_{t-1} + \varepsilon_t$ |
| ARIMA(1,0,0) con constante | Camino aleatorio con deriva | $Y_t = c + Y_{t-1} + \varepsilon_t$ |
...
| ARIMA(1,1,0) | Crecimiento autorregresivo | $\Delta Y_t = \phi \Delta Y_{t-1} + \varepsilon_t, |\phi| \geq 1$ |
